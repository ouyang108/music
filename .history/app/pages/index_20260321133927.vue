...
<template>
  <div class="h-full flex flex-col p-6 overflow-hidden" id="songListContainer">
    ...
    <div
      class="flex-1 bg-white/5 border border-white/5 rounded-2xl overflow-y-auto scrollbar-hide"
    >
      <div
...
<style scoped>
/* 确保背景色和你的整体布局一致，防止滚动时文字重叠 */
.sticky {
  background-color: #181818; /* 建议换成你 layout 的背景色 */
  backdrop-filter: blur(8px); /* 可选：增加磨砂玻璃感 */
}
