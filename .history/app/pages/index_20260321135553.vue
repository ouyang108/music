...
<template>
  <div class="flex-1 flex flex-col p-6 overflow-hidden min-h-0" id="songListContainer">
    ...
    <div
      class="flex-1  flex flex-col bg-white/5 border border-white/5 rounded-2xl overflow-hidden"
    >
      <div
      ...
      <div class="flex-1 overflow-y-auto">
        <div style="height: 100px" v-for="value in musicList">123</div>
      </div>
    </div>
  </div>
</template>
